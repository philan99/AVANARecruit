      ...
      <div className="max-w-3xl mx-auto px-6 lg:px-10 pt-16 pb-20">
        ...
        <div className="space-y-8 text-sm leading-relaxed" style={{ color: "#374151" }}>
          <section>
            ...
            <p className="mt-3">
              The Recruit Terms apply alongside the master <a href="/services-ai/terms" style={{ color: "#4CAF50" }}>AVANA Services Terms and Conditions</a>, which cover account registration, acceptable use, intellectual property, fees, limitation of liability, termination, governing law, and other shared provisions. Where the Recruit Terms address a topic specifically, they take precedence; otherwise the master AVANA Services Terms apply unchanged.
            </p>
            <p className="mt-3">
          ...
          <section>
            ...
            <p>
              All other matters — including account registration, acceptable use, intellectual property, Customer Content licence, fees and payment, limitation of liability, termination, changes to terms and governing law — are governed by the <a href="/services-ai/terms" style={{ color: "#4CAF50" }}>master AVANA Services Terms and Conditions</a>. Please read them in conjunction with this document.
            </p>
          </section>
