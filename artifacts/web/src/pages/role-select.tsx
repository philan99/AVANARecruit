  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: "#ffffff" }}>
      ...
      <section className="py-20 lg:py-28" style={{ backgroundColor: "#f8f9fb" }}>
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 lg:items-end">
      ...
      <section id="pricing" className="py-20 lg:py-28" style={{ backgroundColor: "#f8f9fb" }}>
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <div className="rounded-xl p-8 flex flex-col relative" style={{ backgroundColor: "#1A2035", border: "1px solid #2c3552" }}>
            ...
            <div className="rounded-xl p-8 flex flex-col" style={{ backgroundColor: "#1A2035", border: "1px solid #2c3552" }}>
