...
export function InsightsLegalLayout({ children }: { children: React.ReactNode }) {
  return (
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-10 h-16 flex items-center justify-between">
        <a href="/insights/" className="inline-flex items-center" aria-label="AVANA Insights" data-testid="legal-logo">
          <img src={logoUrl} alt="AVANA Insights" className="h-7 object-contain block" />
        </a>
        <button
          type="button"
          onClick={handleBack}
